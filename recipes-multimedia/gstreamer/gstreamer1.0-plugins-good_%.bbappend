...
SRC_URI:append:qcom = " \
    ...
    file://0005-v4l2object-providing-aligned-size-when-propose-alloc.patch \
    file://0006-v4l2-Drop-empty-bytesused-0-buffers.patch \
    file://0007-v4l2-Handle-GAP-buffer-in-encoder.patch \
    file://0008-v4l2-Add-support-for-V4L2_PIX_FMT_QC10C-format.patch \
"
